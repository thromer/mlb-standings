...
def key2param(key): ...
def build(serviceName, version, http: Incomplete | None = ..., discoveryServiceUrl: Incomplete | None = ..., developerKey: Incomplete | None = ..., model: Incomplete | None = ..., requestBuilder=..., credentials: Incomplete | None = ..., cache_discovery: bool = ..., cache: Incomplete | None = ..., client_options: Incomplete | None = ..., adc_cert_path: Incomplete | None = ..., adc_key_path: Incomplete | None = ..., num_retries: int = ..., static_discovery: Incomplete | None = ..., always_use_jwt_access: bool = ...): ...
