...
def build(
    ...
    discoveryServiceUrl: Incomplete | None = ...,
    developerKey: Incomplete | None = ...,
    model: Incomplete | None = ...,
    requestBuilder: Incomplete = ...,
    credentials: Incomplete | None = ...,
    cache_discovery: bool = ...,
    cache: Incomplete | None = ...,
    client_options: Incomplete | None = ...,
    adc_cert_path: Incomplete | None = ...,
    adc_key_path: Incomplete | None = ...,
    num_retries: int = ...,
    static_discovery: Incomplete | None = ...,
